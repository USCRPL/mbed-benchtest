...
osThreadDef (Th_CountingThread, osPriorityNormal, 0);
...
osThreadDef (Th_Thr0, osPriorityIdle,         0);
osThreadDef (Th_Thr1, osPriorityLow,          0);
osThreadDef (Th_Thr2, osPriorityBelowNormal,  0);
osThreadDef (Th_Thr3, osPriorityNormal,       0);
osThreadDef (Th_Thr4, osPriorityAboveNormal,  0);
osThreadDef (Th_Thr5, osPriorityHigh,         0);
osThreadDef (Th_Thr6, osPriorityRealtime,     0);
osThreadDef (Th_Thr7, osPriorityError,        0);

osThreadDef (Th_Run,  osPriorityIdle,         0);
osThreadDef (Th_isr,  osPriorityIdle,         0);


/* Definitions for TC_ThreadMultiInstance */
void Th_MultiInst (void const *arg);
osThreadDef (Th_MultiInst, osPriorityNormal, 0);
...
osThreadDef (Th_GetId2, osPriorityBelowNormal, 0);
osThreadDef (Th_GetId3, osPriorityBelowNormal, 0);
osThreadDef (Th_GetId4, osPriorityBelowNormal, 0);
osThreadDef (Th_GetId5, osPriorityBelowNormal, 0);
osThreadDef (Th_GetId6, osPriorityBelowNormal, 0);
...
osThreadDef (Th_PrioExec, osPriorityIdle, 0);
...
osThreadDef (Th_Child_0, osPriorityBelowNormal, 0);
osThreadDef (Th_Child_1, osPriorityBelowNormal, 0);
osThreadDef (Th_Child_2, osPriorityBelowNormal, 0);
osThreadDef (Th_Child_3, osPriorityBelowNormal, 0);
...
osThreadDef (Th_YieldTest, osPriorityNormal, 0);
//osThreadDef (Th_YieldTest, osPriorityNormal, 0);
